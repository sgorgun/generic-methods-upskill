...
namespace GenericMethods.Tests.NUnitTests
{
    ...
    internal class ArrayExtensionTypeOfTestFixture<T>
    {
        private readonly T[] expected;
        private readonly object[] source;

        public ArrayExtensionTypeOfTestFixture(object[] source, T[] expected)
        {
        ...
        {
            CollectionAssert.AreEqual(this.expected, this.source.TypeOf<T>());
        }
    }
}
